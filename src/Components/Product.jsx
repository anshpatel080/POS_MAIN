...
function Product() {
  ...
  const addToFavorite = (product, price, url) => {
    ...
    setLikedProducts((prevLikedProducts) => [...prevLikedProducts, favoriteProduct]);
        ...
        <div id="button" className="space-x-3 mr-10 w-1/2 justify-evenly">
          ...
          <div className="flex">
            ...
            <Link className="bg-orange-100" id="button1" to="/login">
              Log in
              <img className="h-6 w-6" src="./images/login.png" alt="login-logo" />
            </Link>
            <Link className="bg-orange-100" id="button1" to="/register">
              Register
              <img className="h-6 w-6" src="./images/register.png" alt="register-logo" />
            </Link>
          </div>
        </div>
      </div>
